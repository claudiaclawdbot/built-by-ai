        ...
        <div style={{ marginTop: '48px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px' }}>
            ...
            <div style={{ background: '#fff', border: '2px solid #6366f1', borderRadius: '12px', padding: '24px', position: 'relative' }}>
              ...
              <a href="https://buy.stripe.com/test_placeholder" style={{ display: 'block', marginTop: '16px', background: '#6366f1', color: '#fff', textAlign: 'center', padding: '12px', borderRadius: '8px', textDecoration: 'none', fontWeight: 700 }}>Get Started</a>
            </div>
            <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '24px' }}>
